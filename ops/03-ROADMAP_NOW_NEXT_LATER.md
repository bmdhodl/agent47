...
| 1.4.0 release | Published 2026-09-24. Receipts in `proof/v1.4.0/PUBLICATION.md`. AG-06 and later adapters stay held. The next release needs a real SDK change, not a docs-only bump. |
