...
- SDK code uses the standard library. Optional extras have independent trees. Audit JSON files retain exact resolved versions. Extra floor pins live in `*-extra-floor.audit.txt` so scanners do not treat them as live pip requirements.
