# AgentGuard dogfood run 18 - 2026-05-29

## Scope

- Branch: `dogfood-2026-05-29-run2-worker`
- Commit before run: `b5200eb`
...
- `python -c "import agentguard, importlib.metadata as m; ..."`
- `agentguard doctor --trace-file proof/dogfood/2026-05-29/run18/installed_doctor_trace.jsonl --json`
- `agentguard demo --trace-file proof/dogfood/2026-05-29/run18/installed_demo_trace.jsonl`
- `python -m agentguard.cli doctor --trace-file proof/dogfood/2026-05-29/run18/repo_doctor_trace.jsonl --json`
- `python -m agentguard.cli demo --trace-file proof/dogfood/2026-05-29/run18/repo_demo_trace.jsonl`
- `python examples/coding_agent_review_loop.py`
- `python -m agentguard.cli report proof/dogfood/2026-05-29/run18/repo_demo_trace.jsonl`
- `python -m agentguard.cli incident --format markdown proof/dogfood/2026-05-29/run18/repo_demo_trace.jsonl`
- `python -m agentguard.cli incident --format markdown proof/dogfood/2026-05-29/run18/coding_agent_review_loop_traces.jsonl`
...
- Proof commands exited 0 except the Glama API snapshot, which returned HTTP 403 from this host and was recorded as external distribution evidence.
- Focused proof/metadata tests passed: 36 passed in 0.41s.
...
- PR #520 has unresolved review feedback around release workflow/release-note handling.
- PR #518 has one stale dogfood cost-proof review thread from earlier sweeps.
...
- Official MCP Registry and Glama indexing remain external distribution follow-ups.
...
- Evidence snapshots: `open-prs.json`, `open-issues.json`, `github-release.json`, `pypi-agentguard47.out.txt`, `npm-mcp-version.out.txt`, `mcp-registry-search.json`, `glama-api.out.txt`
