...
- `PYTHONPATH=./sdk python -m agentguard.cli report proof/dogfood/2026-05-29/run10/agentguard_demo_traces.jsonl`
- `PYTHONPATH=./sdk python -m agentguard.cli incident proof/dogfood/2026-05-29/run10/coding_agent_review_loop_traces.jsonl`
...
- Focused proof tests passed: `35 passed in 1.37s`.
