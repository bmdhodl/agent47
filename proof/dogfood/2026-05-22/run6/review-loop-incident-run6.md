...
Operator note: this report was generated from the current `main` incident
command. Its estimated cost includes both the parent span aggregate and child
cost events. The raw guard event in `coding_agent_review_loop_traces-run6.jsonl`
shows the enforced budget stop at `$0.0510 > $0.0450`.
