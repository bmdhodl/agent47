# Dogfood proof - 2026-05-28 run18
...
The active checkout was bound with PYTHONPATH=./sdk for canonical proof.
...
GitHub release and PyPI latest remain v1.2.10. Local SDK metadata remains
1.2.10.

npm @agentguard47/mcp-server and local MCP metadata remain 0.2.2.

Glama API returned HTTP 403 from this environment. The direct MCP Registry
endpoint returned HTTP 404.

## Validation

- Focused proof tests passed: 40 passed.
- Release guard passed.
- git diff --check passed.
- Artifact JSON/JSONL, UTF-8, BOM, NUL, and local-path hygiene passed.
