...
- Local proof commit base: `a49e8cc5582dc00b44a617a49e31446431be0dc5`
- SDK version: `1.2.10`
...
```powershell
$env:PYTHONPATH='./sdk'
python -m agentguard.cli doctor --json
python -m agentguard.cli demo
python -m agentguard.cli report proof/dogfood/2026-05-28/run12/repo_demo_trace.jsonl
python -m agentguard.cli incident proof/dogfood/2026-05-28/run12/repo_demo_trace.jsonl --format markdown
python examples/coding_agent_review_loop.py
python -m agentguard.cli report proof/dogfood/2026-05-28/run12/coding_agent_review_loop_traces.jsonl
python -m agentguard.cli incident proof/dogfood/2026-05-28/run12/coding_agent_review_loop_traces.jsonl --format markdown
```
...
Installed CLI comparison proof also emitted the same demo guard events, but the
...
- Focused pytest: `43 passed in 1.75s`
...
- Open security/dependency issues #469 and #507 remain real follow-ups.
