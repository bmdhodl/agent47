...
paid features, new SDK features, or dependency changes.

## Repo State

- Repo: `bmdhodl/agent47`
- Branch proof target: PR #540, `dogfood-2026-05-28-run8-worker`
- Local proof commit base: `09b06991d13154a0654abad0ffd1333b52c72ce0`
- SDK version: `1.2.10`
...
```powershell
agentguard doctor --trace-file proof/dogfood/2026-05-28/run14/installed_doctor_trace.jsonl --json
agentguard demo --trace-file proof/dogfood/2026-05-28/run14/installed_demo_trace.jsonl
```
...
```powershell
$env:PYTHONPATH='./sdk'
python -m agentguard.cli doctor --trace-file proof/dogfood/2026-05-28/run14/repo_doctor_trace.jsonl --json
python -m agentguard.cli demo --trace-file proof/dogfood/2026-05-28/run14/repo_demo_trace.jsonl
python -m agentguard.cli report proof/dogfood/2026-05-28/run14/repo_demo_trace.jsonl
python -m agentguard.cli incident proof/dogfood/2026-05-28/run14/repo_demo_trace.jsonl --format markdown
python examples/coding_agent_review_loop.py
python -m agentguard.cli report proof/dogfood/2026-05-28/run14/coding_agent_review_loop_traces.jsonl
python -m agentguard.cli incident proof/dogfood/2026-05-28/run14/coding_agent_review_loop_traces.jsonl --format markdown
```
...
installed `agentguard` import path still resolves outside this active proof
checkout. The canonical proof for this PR is therefore the repo-local
`PYTHONPATH=./sdk` run.
...
- Focused pytest: `43 passed in 1.41s`
...
- The older dogfood proof PR queue remains green/review-blocked.
