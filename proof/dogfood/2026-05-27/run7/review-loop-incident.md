...
Known issue: this generated incident summary double-counts review-loop cost on
current `main`. The raw trace has three `review.iteration` costs totaling
`$0.0510`, and `guard.budget_exceeded` stopped the run at `$0.0510 > $0.0450`.
