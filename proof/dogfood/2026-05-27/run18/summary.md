# AgentGuard Dogfood Run 18 - 2026-05-27
...
```powershell
agentguard doctor --trace-file proof/dogfood/2026-05-27/run18/agentguard_doctor_trace.jsonl
agentguard demo --trace-file proof/dogfood/2026-05-27/run18/agentguard_demo_traces.jsonl
```
...
py -m agentguard.cli doctor --trace-file proof/dogfood/2026-05-27/run18/checkout_agentguard_doctor_trace.jsonl
py -m agentguard.cli demo --trace-file proof/dogfood/2026-05-27/run18/checkout_agentguard_demo_traces.jsonl
py -m agentguard.cli report proof/dogfood/2026-05-27/run18/checkout_agentguard_demo_traces.jsonl
py -m agentguard.cli incident proof/dogfood/2026-05-27/run18/checkout_agentguard_demo_traces.jsonl --format markdown
py examples/coding_agent_review_loop.py
py -m agentguard.cli incident proof/dogfood/2026-05-27/run18/coding_agent_review_loop_traces.jsonl --format markdown
```
...
py -m pytest sdk/tests/test_demo.py sdk/tests/test_doctor.py sdk/tests/test_cli_report.py sdk/tests/test_example_starters.py -q
git diff --check -- proof/dogfood/2026-05-27/run18
```
...
- `git diff --check -- proof/dogfood/2026-05-27/run18` passed after this summary was added.
