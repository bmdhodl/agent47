# AgentGuard Dogfood Run 16 - 2026-05-27
...
```powershell
agentguard doctor --trace-file proof/dogfood/2026-05-27/run16/agentguard_doctor_trace.jsonl
agentguard demo --trace-file proof/dogfood/2026-05-27/run16/agentguard_demo_traces.jsonl
```
...
py -m agentguard.cli doctor --trace-file proof/dogfood/2026-05-27/run16/checkout_agentguard_doctor_trace.jsonl
py -m agentguard.cli demo --trace-file proof/dogfood/2026-05-27/run16/checkout_agentguard_demo_traces.jsonl
py -m agentguard.cli report proof/dogfood/2026-05-27/run16/checkout_agentguard_demo_traces.jsonl
py -m agentguard.cli incident proof/dogfood/2026-05-27/run16/checkout_agentguard_demo_traces.jsonl --format markdown
py examples/coding_agent_review_loop.py
py -m agentguard.cli incident proof/dogfood/2026-05-27/run16/coding_agent_review_loop_traces.jsonl --format markdown
```
...
git diff --check -- proof/dogfood/2026-05-27/run16
```
...
- `guard.budget_exceeded`: 2
- `guard.retry_limit_exceeded`: 2
...
- Artifact hygiene passed: no UTF-8 BOM or NUL bytes found.
- Focused pytest passed: `30 passed`.
- `git diff --check -- proof/dogfood/2026-05-27/run16` passed.
