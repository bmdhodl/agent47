...
- **Package:** `agentguard47` on PyPI (release status tracked in `memory/state.md`; release candidate: v1.3.0)
...
**Current:** current SDK release candidate is 1.3.0. Read `memory/` for the
...
- **Version:** current release candidate is 1.3.0. Check `sdk/pyproject.toml` for the branch version under preparation.
