...
- **Package:** `agentguard47` on PyPI. Latest tagged release: `v1.2.7`. Current branch version under prep: `v1.2.8`.
...
**Current:** shipped SDK release on PyPI is `v1.2.7`; this branch is preparing `v1.2.8`. Read `memory/` for the
...
- **Version:** latest tagged release is `1.2.7`. Check `sdk/pyproject.toml` for the current branch version under preparation (`1.2.8`).
