...
**Current:** current SDK release candidate is 1.2.14. Read `memory/` for the
...
- **Version:** current release candidate is 1.2.14. Check `sdk/pyproject.toml` for the branch version under preparation.
