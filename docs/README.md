...
- [Reservation contract](guides/reservation-contract.md): local reserve/commit/cancel/unresolved rules. Wired for store-backed sync OpenAI Chat Completions only.
